...
public class Database {
    ...
    public ResultSet executeQuery(DBRequest request) throws SQLException {
        return executeQuery(request.getSql(), request.getArgs());
    }

    public int executeUpdate(DBRequest request) throws SQLException {
        return executeUpdate(request.getSql(), request.getArgs());
    }
